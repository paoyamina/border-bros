          ...
          <div style={estilos.section}>
            ...
            <div style={{ display: "flex", gap: "5px" }}>
              ...
              <input
                ...
                <datalist id="categorias-egreso-banca">
...
<datalist id="conceptos-egresos-banca">
    ...
    <option key={concepto} value={concepto} />
            ...
            <div style={{ display: "flex", gap: "5px" }}>
              ...
              <input
                ...
                <datalist id="proveedores-egreso-banca">
