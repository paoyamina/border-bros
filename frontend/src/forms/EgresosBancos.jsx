...
const descargarExcelBanco = () => {
  ...
  XLSX.utils.book_append_sheet(libro, hoja, "Egreso Bancos");

  XLSX.writeFile(
    libro,
    `Egreso_Bancos_BOSSE_${fechaEgreso}_${referencia || "SinReferencia"}.xlsx`
  );
};
...
`);
  ...
  formData.append(
    "nombreCarpeta",
    `EGRESO_BANCOS_${fechaEgreso}_${beneficiarioEgreso}`
  );
...
if (!resultadoBD.success) {
  throw new Error(
    resultadoBD.error || "Error al guardar en base de datos."
  );
}
...
window.dispatchEvent(new Event("egresoActualizado"));
  ...
  alert("🚨 Error al registrar egreso bancario: " + error.message);
}
  };
    ...
    <div style={estilos.container}>
      <div style={estilos.card}>
        ...
        <div style={estilos.logoSpace}>
          ...
          <h1 style={estilos.h1}>Egresos Bancos</h1>
          ...
          <div style={estilos.section}>
            ...
            <div style={{ display: "flex", gap: "5px" }}>
              ...
              <input
                ...
                <datalist id="categorias-egreso-bancos">
  ...
  {conceptosExistentes.map((concepto) => (
    <option key={concepto} value={concepto} />
            ...
            <div style={{ display: "flex", gap: "5px" }}>
              ...
              <input
                  type="text"
                  list="proveedores-egreso-bancos"
                ...
                <datalist id="proveedores-egreso-bancos">
